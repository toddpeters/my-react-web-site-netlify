...
class JavaScript extends React.Component {
            ...
            >
              ...
              <div className="modal-body">
                <p>
                  ...
                  Vitae elementum curabitur vitae nunc. Pharetra vel turpis nunc
                  eget lorem dolor sed viverra. Elementum curabitur vitae nunc
                  sed. Sed tempus urna et pharetra pharetra massa massa
                  ultricies. Aliquam ut porttitor leo a. Sit amet consectetur
                  adipiscing elit pellentesque habitant morbi tristique. Nisl
                  pretium fusce id velit ut tortor pretium viverra. A lacus
                  vestibulum sed arcu non. Sed velit dignissim sodales ut eu
                  sem.
                </p>
              </div>
 ...
 Here will be some very useful information about this popover."
              ...
              <UncontrolledPopover placement="right" target="tooltip72798464">
                ...
                <PopoverBody>
                  Here will be some very useful information about this popover.
                  <br /> Here will be some very useful information about this
                  popover.
                </PopoverBody>
              </UncontrolledPopover>
              <Button
            ...
            <Row className="justify-content-between align-items-center">
              <Col className="mb-5 mb-lg-0" lg="5">
                ...
                <p className="text-white mt-4">
                  This Template comes with three pre-built pages. You can change
                  the text and images and you're good to go.
                </p>
                <Button className="mt-4" color="warning" href="https://">
                  See all components
                </Button>
              </Col>
              <Col lg="6">
